            ...
            */
            ...
            'settings' => [
                ...
                */
                ...
                'hosts' => explode(' ', env('LDAP_HOSTS', 'com-nic1.nic1.elavt.spb.ru')),
                ...
                */
                ...
                'base_dn' => env('LDAP_BASE_DN', 'OU=NIC-1,DC=nic1,DC=elavt,DC=spb,DC=ru'),
                ...
                */
                ...
                'username' => env('LDAP_USERNAME', 'NIC1\stend'),
                'password' => env('LDAP_PASSWORD', 'Elavt123'),
